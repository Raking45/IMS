      ...
      <div *ngIf="showCalendar" class="calendar-popup">
        <div class="calendar">
          <div class="calendar-header">
            <button class="calendar-nav-button" (click)="debounce(prevMonth)">&#9664;</button>
            <span class="calendar-month">{{ currentDate | date: 'MMMM yyyy' }}</span>
            <button class="calendar-nav-button" (click)="debounce(nextMonth)">&#9654;</button>
          </div>

          <div class="calendar-days">
            <div *ngFor="let day of ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']; trackBy: trackByIndex" class="calendar-day-name">
              {{ day }}
            </div>
            <div *ngFor="let day of daysInMonth; trackBy: trackByIndex" class="calendar-day" (click)="day && selectDate(day)">
              {{ day }}
            </div>
          </div>
        </div>
